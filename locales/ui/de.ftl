...
tasks-statusCancelling = Wird abgebrochen…
...
siteValidation-complete = Validierung abgeschlossen
...
settings-rebuildPostLinks = Beitragslinks werden neu aufgebaut…
settings-rebuildMediaLinks = Medienlinks werden neu aufgebaut…
...
metadataDiff-repair = Metadaten werden repariert…
metadataDiff-complete = Metadatenvergleich abgeschlossen
metadataDiff-importOrphan = Datei importieren
metadataDiff-orphanImported = Verwaiste Datei importiert
...
engine-progress-rebuildingThumbnails = Fehlende Vorschaubilder werden neu aufgebaut…
...
engine-prepareGeneration = Website-Generierung vorbereiten
engine-preparingGeneration = Routen und Vorlagen werden vorbereitet…
engine-generationPrepared = Website-Generierung vorbereitet
...
engine-generationCancellationRequested = Website-Erstellung wird abgebrochen…
...
tui-taskCancelling = { $label } — wird abgebrochen…
