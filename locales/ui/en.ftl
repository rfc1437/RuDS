...
tasks-statusCancelling = Cancelling…
...
siteValidation-complete = Validation complete
...
editor-archived = Moved to archive.
...
settings-rebuildPostLinks = Rebuilding post links…
settings-rebuildMediaLinks = Rebuilding media links…
...
metadataDiff-repair = Repairing metadata…
metadataDiff-complete = Metadata comparison complete
metadataDiff-importOrphan = Import File
metadataDiff-orphanImported = Orphan file imported
...
engine-progress-rebuildingThumbnails = Rebuilding missing thumbnails…
...
engine-prepareGeneration = Prepare site generation
engine-preparingGeneration = Preparing routes and templates…
engine-generationPrepared = Site generation prepared
...
engine-generationCancellationRequested = Cancelling site generation…
...
tui-taskCancelling = { $label } — cancelling…
