...
tasks-statusCancelling = Annullamento…
...
siteValidation-complete = Validazione completata
...
editor-archive = Archivia
editor-archived = Spostato in archivio.
...
settings-rebuildPostLinks = Ricostruzione dei link degli articoli…
settings-rebuildMediaLinks = Ricostruzione dei link multimediali…
...
metadataDiff-repair = Riparazione dei metadati…
metadataDiff-complete = Confronto dei metadati completato
metadataDiff-importOrphan = Importa file
metadataDiff-orphanImported = File orfano importato
...
engine-progress-rebuildingThumbnails = Ricostruzione delle miniature mancanti…
...
engine-prepareGeneration = Prepara la generazione del sito
engine-preparingGeneration = Preparazione di percorsi e modelli…
engine-generationPrepared = Generazione del sito preparata
...
engine-generationCancellationRequested = Annullamento della generazione del sito…
...
tui-taskCancelling = { $label } — annullamento…
