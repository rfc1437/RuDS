...
tasks-statusCancelling = Annulation…
...
siteValidation-complete = Validation terminée
...
editor-archived = Déplacé dans les archives.
...
settings-rebuildPostLinks = Reconstruction des liens d’articles…
settings-rebuildMediaLinks = Reconstruction des liens de médias…
...
metadataDiff-repair = Réparation des métadonnées…
metadataDiff-complete = Comparaison des métadonnées terminée
metadataDiff-importOrphan = Importer le fichier
metadataDiff-orphanImported = Fichier orphelin importé
...
engine-progress-rebuildingThumbnails = Reconstruction des miniatures manquantes…
...
engine-prepareGeneration = Préparer la génération du site
engine-preparingGeneration = Préparation des routes et des modèles…
engine-generationPrepared = Génération du site préparée
...
engine-generationCancellationRequested = Annulation de la génération du site…
...
tui-taskCancelling = { $label } — annulation…
